...
#SBATCH --job-name=m_Kmeans
#SBATCH --mail-user=rbaingol@buffalo.edu
#SBATCH --output=kmeans_1.out
#SBATCH --error=kmeans_1.out
...
$MAHOUT_HOME/bin/mahout kmeans -i /data/tweets-vectors/tfidf-vectors -c /data/input_clusters -o /data/output_clusters -cd 0.1 -x 3 -k 7 -ow 
...
$MAHOUT_HOME/bin/mahout clusterdump -i /data/output_clusters/clusters-* -o output.txt -d /data/tweets-vectors/dictionary.file-0 -dt sequencefile -n 20 -b 100 
