...
#SBATCH --output=Result_word_count_4_1000000.out
#SBATCH --error=Result_word_count_4_1000000.out
...
module list
echo "START WRITING README"
java -jar random.jar -t 1000000 README.txt
sleep 15
...
$HADOOP_HOME/bin/hadoop --config $HADOOP_CONF_DIR jar sort.jar README.txt output_wordcount
