...
#SBATCH --job-name=mahout_recommender
#SBATCH --mail-user=manojmar@buffalo.edu
#SBATCH --output=Result_mahout_recommender.out
#SBATCH --error=Result_mahout_recommender.out
...
$HADOOP_HOME/bin/hadoop --config $HADOOP_CONF_DIR dfs -put data
...
$HADOOP_HOME/bin/hadoop --config $HADOOP_CONF_DIR jar weather.jar  WeatherPredictor  /user/manojmar/mahout/final.csv

echo "ls files in dfs"
#$HADOOP_HOME/bin/hadoop --config $HADOOP_CONF_DIR fs -ls output_mahout_recommender

echo "Copy output from HDFS to local directory"
#$HADOOP_HOME/bin/hadoop --config $HADOOP_CONF_DIR fs -get output_mahout_recommender output_mahout_recommender
